        ...
        <AppLayout>
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-display-sm font-semibold text-ink">Tambah Pengguna Baru</h1>
                        <p className="text-body-sm text-mute mt-1">Buat akun akses baru dan tetapkan peran (Role) pengguna.</p>
                    </div>
                ...
                <div className="bg-canvas border border-hairline rounded-md shadow-[0px_1px_1px_#00000005,0px_2px_2px_#0000000a] p-6">
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <Label htmlFor="password" className="text-body-sm-strong text-ink">Kata Sandi (Password) *</Label>
                                <Input
                                    id="password"
                                    type="password"
                                    value={data.password}
                            ...
                            <div>
                                ...
                                <Select
                                    value={data.status}
                                    onValueChange={(val: string) => setData('status', val)}
                                >
                                    <SelectTrigger className="mt-1">
