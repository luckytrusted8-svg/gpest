    ...
    return (
        <AppLayout>
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="bg-canvas border border-hairline rounded-md p-3.5 shadow-2xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-body-xs bg-canvas-soft/40">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-canvas border border-hairline rounded-md p-4 shadow-[0px_1px_1px_#00000005,0px_2px_2px_#0000000a]">
