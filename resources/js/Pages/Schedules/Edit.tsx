...
export default function Edit({ schedule, customers, contracts, users }: Props) {
    const { data, setData, put, processing, errors } = useForm<FormData>({
        ...
        jam_selesai: schedule.jam_selesai ? schedule.jam_selesai.substring(0, 5) : '10:00',
    ...
    return (
        <AppLayout>
            <Head title={`Edit Jadwal: ${schedule.schedule_code}`} />

            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-display-sm font-semibold text-ink font-mono">Edit Jadwal: {schedule.schedule_code}</h1>
                        <p className="text-body-sm text-mute mt-1">Perbarui detail tugas dan alokasi teknisi.</p>
                    </div>
