        ...
        <AppLayout>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-display-sm font-semibold text-ink">Create Contract</h1>
                        <p className="text-body-sm text-mute mt-1">Add a new customer contract to the system.</p>
                    </div>
