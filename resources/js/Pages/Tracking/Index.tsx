...
const statusDotColors: Record<string, string> = {
    ...
    dalam_perjalanan: 'bg-blue-600',
    tiba: 'bg-purple-600',
    bekerja: 'bg-amber-500',
    offline: 'bg-slate-400',
};

const statusBadgeColors: Record<string, string> = {
    aktif: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    dalam_perjalanan: 'bg-blue-50 text-blue-700 border-blue-200',
    tiba: 'bg-purple-50 text-purple-700 border-purple-200',
    bekerja: 'bg-amber-50 text-amber-800 border-amber-200',
