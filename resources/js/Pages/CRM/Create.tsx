...
export default function Create({ salesUsers }: Props) {
    ...
    return (
        <AppLayout>
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div>
                    <h1 className="text-display-sm font-semibold text-ink">Tambah Lead Baru</h1>
                    <p className="text-body-sm text-mute mt-1">Isi data lead prospek pelanggan baru.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-canvas border border-hairline rounded-md shadow-[0px_1px_1px_#00000005,0px_2px_2px_#0000000a] p-6 space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="sm:col-span-2 space-y-2">
                                ...
                                <textarea value={data.kebutuhan} onChange={(e) => setData('kebutuhan', e.target.value)} className="flex w-full rounded-md border border-hairline bg-canvas px-3 py-2 text-body-sm text-ink focus:outline-none focus:ring-1 focus:ring-primary min-h-[80px] resize-y" placeholder="Deskripsikan kebutuhan customer..." />
                            </div>
                            <div className="sm:col-span-2 space-y-2">
                                <Label>Catatan</Label>
                    ...
                    <div className="flex justify-end gap-3">
                        <Link href="/crm"><Button type="button" variant="outline" className="text-body-sm-strong">Batal</Button></Link>
                        <Button type="submit" className="bg-primary text-on-primary hover:bg-ink text-body-sm-strong" disabled={processing}>{processing ? 'Menyimpan...' : 'Simpan Lead'}</Button>
                    </div>
                </form>
            </div>
        </AppLayout>
